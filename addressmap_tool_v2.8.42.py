...
def grid_collect_poi(gkey, clng, clat, kw, radius, stop_check=None, log_cb=None, poly=None):
    ...
    try:
        ...
        for dx, dy in offsets:
            ...
            truncated = scan_point(c_lng, c_lat, d)
            # 中心点被截断（高密度区域）：半径减半拆 4 子点补扫，突破单点上限
            if truncated and dx == 0 and dy == 0 and d / 2.0 >= 2000:
                sub = d / 2.0
                sdlat = sub / 111000.0

...
class App:
    ...
    def _build_settings(self):
        ...
        tk.Label(r3, text="深挖并发数：", font=("微软雅黑", 11), bg=Config.C_CARD, fg=Config.C_TEXT).pack(side=tk.LEFT, padx=(24, 0))
        self.cfg_gw = tk.Spinbox(r3, from_=1, to=5, increment=1, width=5, font=("微软雅黑", 10), relief=tk.SOLID, bd=1)

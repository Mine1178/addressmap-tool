...
class App:
    ...
    def _build_settings(self):
        ...
        tk.Label(r4, text="POI 网格深挖并发线程数（1-5，默认 2 为召回完整与速度的最优平衡）",
        ...
        for t in ["• 支持 OpenAI 兼容协议的模型平台：豆包（火山方舟）/ DeepSeek / 通义千问 / Kimi / 智谱 GLM / OpenAI 等",
        ...
        for _k, _info in Config.AI_PROVIDERS.items():
            _row2 = tk.Frame(mc, bg=Config.C_CARD); _row2.pack(fill=tk.X, padx=16, pady=2)
